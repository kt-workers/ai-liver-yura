...
def to_streaming_error(error: YouTubeApiError) -> StreamingError:
    code_by_kind = {
        ...
        YouTubeApiErrorKind.NETWORK: StreamingErrorCode.EXTERNAL_DEPENDENCY_ERROR,
        YouTubeApiErrorKind.SERVER: StreamingErrorCode.EXTERNAL_DEPENDENCY_ERROR,
        YouTubeApiErrorKind.INVALID_RESPONSE: StreamingErrorCode.INVALID_REQUEST,
    }

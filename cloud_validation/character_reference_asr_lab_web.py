            ...
            items.append(
                {
                    ...
                    "preview_available": source.thumbnail_available,
...
function thumb(x){if(!x.drive_thumbnail_available)return '<div class="thumb">No preview</div>';const q=encodeURIComponent(String(x.reference_id));return `<div class="thumb"><img src="/api/thumbnail?reference_id=${q}" alt="" loading="lazy" onerror="this.parentElement.textContent='No preview'"></div>`}

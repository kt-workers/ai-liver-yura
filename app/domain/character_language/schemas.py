...
def character_language_instructions() -> str:
    ...
    return "\n".join(
        (
            ...
            "- 意味保持、自然さ、Characterらしさ、反復回避の順で優先してください。",
            "- 語彙、語順、rhythm、phrase segmentationの自然なvariationは許可されますが、",
            ...
            "  直近same-Plan表現です。How-to-say上のweak repetition-awareness referenceとして",
            "  だけ使ってください。",
            (
            ...
            "- priorとの重複は、自然で意味安全な別表現が明らかにある場合だけ避けても構いません。",
            "- priorと同じ表現が最も自然で意味安全なら、そのまま再使用して構いません。",
            "- exact duplicate自体をfailureとして扱わないでください。",

...
class PluginRegistryAuthority:
    ...
    def discover(self, manifest: PluginManifest, occurred_at: datetime) -> RegisteredPluginView:
        return self._admit(manifest, PluginLifecycleState.DISCOVERED, occurred_at)

    def validate(self, plugin_id: str, occurred_at: datetime) -> RegisteredPluginView:
        return self._transition(
            plugin_id, PluginLifecycleState.DISCOVERED, PluginLifecycleState.VALIDATED, occurred_at
        )

    def register(self, plugin_id: str, occurred_at: datetime) -> RegisteredPluginView:
        return self._transition(
            plugin_id, PluginLifecycleState.VALIDATED, PluginLifecycleState.REGISTERED, occurred_at
        )

    def register_manifest(
        self, manifest: PluginManifest, occurred_at: datetime
    ) -> RegisteredPluginView:
        return self._admit(manifest, PluginLifecycleState.REGISTERED, occurred_at)

    def adopt_permission_grants(
        self, snapshot: PluginPermissionGrantSnapshot
    ) -> PluginRegistrySnapshot:
    ...
    def begin_stop(self, plugin_id: str, occurred_at: datetime) -> RegisteredPluginView:
        return self._transition(
            plugin_id,
            (
    ...
    def mark_stopped(self, plugin_id: str, occurred_at: datetime) -> RegisteredPluginView:
        return self._transition(
            plugin_id, PluginLifecycleState.STOPPING, PluginLifecycleState.STOPPED, occurred_at
        )

    def unregister(self, plugin_id: str, occurred_at: datetime) -> None:
    ...
    def _admit(
        self, manifest: PluginManifest, state: PluginLifecycleState, occurred_at: datetime
    ) -> RegisteredPluginView:

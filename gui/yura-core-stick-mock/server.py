...
class PoseFrameHub:
    """Coreから受け取った最新Poseを保持するだけの表示用Hub。"""
...
class Handler(BaseHTTPRequestHandler):
    server_version = "YuraCoreStickMock/1.0"
    ...
    def log_message(self, format: str, *args: object) -> None:
        print(f"[stick-mock] {self.address_string()} {format % args}")
...
def main() -> None:
    ...
    print(f"Yura Core Stick Mock: http://{host}:{port}")
    print("This process only renders BodyPoseFrame generated by Core.")
    try:

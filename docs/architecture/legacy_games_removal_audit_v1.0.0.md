...
> 実施状況（2026-07-30）: PR AはPR #100で完了した。PR Bでは本監査の分類に従って旧Games Pluginとしりとりを物理削除する。本書の「現在」は監査時点の過去構成を示し、削除後の現行仕様は`subsystem_architecture_policy_v1.0.0.md`と`source_file_plan.md`を正本とする。
